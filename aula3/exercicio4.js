/*
    ...
    você pode atribuir o valor dessa variável a outra variável usando o operador de atribuição, como no exemplo a seguir:
    ...
    Atribua o conteúdo de salarioBase à variável salarioFuncionadoNovo
*/
