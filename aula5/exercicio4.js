/*
  Você deve se lembrar que conseguimos atribuir valores para variáveis, certo? 
  Uma coisa legal que Javascript nos permite, é atribuir o retorno de uma função para uma variável, vamos ver como:
