/*
    ...
    .pop() é usado para retirar um valor do final de uma matriz. 
    Podemos armazenar esse valor destacado atribuindo-o a uma variável. 
    Em outras palavras, .pop()remove o último elemento de uma matriz e retorna esse elemento. 
...
*/
    ...
    const nossoArray = ["Caroline", "Pereira", "js"];
...
*/
    ...
    const bonusArray = ["Caroline", "Pereira", "js"];
    const removidoInicio = bonusArray.shift();
    console.log(removidoInicio);
